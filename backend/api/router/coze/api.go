...
func Register(r *server.Hertz) {
	...
	root := r.Group("/", rootMw()...)
	{
		...
		}
		{
			...
			_workflow_api.POST("/copy_with_plugins", append(_copyworkflowwithpluginsMw(), coze.CopyWorkflowWithPlugins)...)
			...
			_workflow_api.GET("/first_admin_published_workflows", append(_getfirstadminpublishedworkflowsMw(), coze.GetFirstAdminPublishedWorkflows)...)
